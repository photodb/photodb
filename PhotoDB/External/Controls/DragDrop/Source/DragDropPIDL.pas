...
procedure SHFree(Buffer: Pointer); stdcall {$ifdef VER15_PLUS} deprecated {$endif}; external shell32 index 195 delayed;
function SHAlloc(BufferSize: ULONG): Pointer; stdcall {$ifdef VER15_PLUS} deprecated {$endif}; external shell32 index 196 delayed;
{$endif}
