  ...
  begin
   ...
   begin
    ...
    begin
     ...
     begin
      _sqlexectext:='UPDATE '+GetDefDBname+' SET FFileName="'+AnsiLowerCase(normalizeDBFileNameString(NormalizeDBString(NewPath)))+'" , FolderCRC = '+Format('%d',[crc])+' where ID = '+IntToStr(WorkQuery.FieldByName('ID').AsInteger);
