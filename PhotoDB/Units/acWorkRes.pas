...
************************************************************************
  ...
  Автор:    Сальников А.А.
  Версия:   1.10.14  21.07.04
            - Были сделаны все изменения, которые сделал разработчик
              madRes в версии 1.0h.
            1.10.14  21.07.04
            - Добавлена функция "LoadFileResourceW" - Функция записи
              файла в ресурсы.
            - Добавлена функция "LoadFileResource" - Функция записи
              файла в ресурсы без задания языка.
            - Добавлена функция "SaveFileResourceW" - Функция извлечение
              файла из ресурсов.
            - Добавлена функция "SaveFileResource" - Функция извлечение
              файла из ресурсов без задания языка.
            - Добавлена функция "SaveFileToDiscW" - Сохранение ресурса
              ввиде файла на диск.
            - Добавлена функция "LoadFileToResourceW" - Сохранение
              ресурса в виде файла на диск.
            1.04.07  19.07.04
            - Добавлена функция "PWideToString" - Преобразование
              PWideChar в String.
            - Исправлена ошибка в функция "SaveIconToDiscW", которая
              возникала на некоторых системах семейства Win9x.
            1.03.05  17.04.04
            - Добавлена функция "StringToPWide" - Преобразование String
              в PWideChar.
            1.02.04  16.04.04
